...
/**
 * The type of the redux action which toggles the top navigation visibility regardless of it's current state.
 *
 * {
 *     type: TOGGLE_TOP_NAVIGATION_VISIBLE
 * }
 */
export const TOGGLE_TOP_NAVIGATION_VISIBLE = "TOGGLE_TOP_NAVIGATION_VISIBLE";
